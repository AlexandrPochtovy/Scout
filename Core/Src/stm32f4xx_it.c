...
void TIM8_UP_TIM13_IRQHandler(void)
{
	...
	if (sr & TIM_SR_UIF) {
		...
		case 4:
			...
			break;
		case 5:
			leftWheelPWM = PID_MotoFilteredProcessing(Drive.WL.speedSP, Drive.WL.speedAct, 0, 3999,  &PidMotoFilter_L);
			rightWheelPWM = PID_MotoFilteredProcessing(Drive.WR.speedSP, Drive.WR.speedAct, 0, 3999, &PidMotoFilter_R);
			break;
		default:
			//rightWheelPWM = leftWheelPWM = 0;
			break;
